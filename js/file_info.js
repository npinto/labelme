...
function file_info() {
  ...
  this.ParseURL = function () {
	...
	p.parentNode.removeChild(p);
	var p = document.getElementById('img_xml_download_div');
	p.parentNode.removeChild(p);
	document.getElementById('body').style.visibility = 'visible';
      }
      else {
	...
	document.getElementById('body').style.visibility = 'visible';
      ...
      if(!view_ObjList) {
	var p = document.getElementById('right_side');
	p.parentNode.removeChild(p);
      }
	...
	InsertAfterDiv(html_str,'mt_submit_form');
	...
	InsertAfterDiv(html_str2,'mt_feedback');
  ...
  this.GetTemplatePath = function () {
    if(!this.dir_name) return 'XMLTemplates/labelme.xml';
    return 'XMLTemplates/' + this.dir_name + '.xml';
  };
  ...
  this.SetURL = function (url) {
    ...
    if(this.mode=='i') window.location = url + '?collection=' + this.collection + '&mode=' + this.mode + '&folder=' + this.dir_name + '&image=' + this.im_name;
    else if(this.mode=='im') window.location = url + '?collection=' + this.collection + '&mode=' + this.mode + '&folder=' + this.dir_name + '&image=' + this.im_name;
    else if(this.mode=='mt') window.location = url + '?collection=' + this.collection + '&mode=' + this.mode + '&folder=' + this.dir_name + '&image=' + this.im_name;
    else if(this.mode=='v') window.location = url + '?collection=' + this.collection + '&mode=' + this.mode + '&folder=' + this.dir_name +'&movie=' + this.mov_name + '&image=' + this.im_name;
    else if(this.mode=='c') window.location = url + '?mode=' + this.mode + '&username=' + username + '&collection=' + this.collection + '&folder=' + this.dir_name + '&image=' + this.im_name;
    else if(this.mode=='f') window.location = url + '?mode=' + this.mode + '&folder=' + this.dir_name + '&image=' + this.im_name;
    return false;
  };

  // Fetch next image.
  this.FetchImage = function () {
    var url = 'fetch_image.cgi?mode=' + this.mode + '&username=' + username + '&collection=' + this.collection.toLowerCase() + '&folder=' + this.dir_name + '&image=' + this.im_name;
    var im_req;
