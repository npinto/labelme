...
function GetNWImg() {
  if(IsNetscape() || IsSafari()) {
    ...
    '-moz-user-select: none;" src="GoogleIcons/iw_nw.png" height="25"'+
    ' width="25" />';
  }
  else if(IsMicrosoft()) {
    return '<img style="border: 0pt none; width: 25px; height: 25px; '+
    'position: absolute; left: 0px; top: 0px; z-index: 0; '+
    '-moz-user-select: none;" src="GoogleIcons/iw_nw.gif" height="25"'+
    ' width="25" />';
  }
}
...
function GetNImg() {
  ...
  'width: 212px;" src="GoogleIcons/iw_n.png" height="25" width="640" />';
}
...
function GetNEImg() {
  if(IsNetscape() || IsSafari()) {
    ...
    ' src="GoogleIcons/iw_ne.png" height="25" width="25" />';
  }
  else if(IsMicrosoft()) {
     return '<img style="border: 0pt none ; width: 25px;'+
    'height: 25px; position: absolute; top: 0px; z-index: 0;'+
    '-moz-user-select: none; left: 237px;"'+
    ' src="GoogleIcons/iw_ne.gif" height="25" width="25" />';
  }
}
...
function GetWImg() {
  ...
  'height: 92px;" src="GoogleIcons/iw_w.png" height="640" width="25" />';
}

function GetCImg() {
  return '<img style="border: 0pt none ; position:'+
  'absolute; left: 25px; top: 25px; z-index: 0; -moz-user-select: none;'+
  'width: 212px; height: 92px;" src="GoogleIcons/iw_c.png" height="640"'+
  ' width="640" />';
}
...
function GetEImg() {
  ...
  'left: 237px;" src="GoogleIcons/iw_e.png" height="640" width="25" />';
}
...
function GetSWImg() {
  ...
  'src="GoogleIcons/iw_sw.png" height="96" width="25" />';
...
function GetSLeftImg() {
  ...
  'top: 117px;" src="GoogleIcons/iw_s.png" height="96" width="640" />';
}
...
function GetSTapImg() {
  if(IsNetscape() || IsSafari()) {
    ...
    'top: 117px;" src="GoogleIcons/iw_tap.png" height="96" width="98" />';
  }
  else if(IsMicrosoft()) {
    return '<img style="border: 0pt none ; width: 98px; height: 96px;'+
    'position: absolute; z-index: 0; -moz-user-select: none; left: 0px;'+
    'top: 117px;" src="GoogleIcons/iw_tap.gif" height="96" width="98" />';
  }
}
...
function GetSRightImg() {
  if(IsNetscape() || IsSafari()) {
    ...
    'width: 139px; top: 117px;" src="GoogleIcons/iw_s.png" height="96" width="640" />';
  }
  else if(IsMicrosoft()) {
    return '<img style="border: 0pt none ; height: 96px;'+
    'position: absolute; z-index: 0; -moz-user-select: none; left: 98px;'+
    'width: 139px; top: 117px;" src="GoogleIcons/iw_s.gif" height="96" width="640" />';
  }
}
...
function GetSEImg() {
  if(IsNetscape() || IsSafari()) {
    ...
    'top: 117px;" src="GoogleIcons/iw_se.png" height="96" width="25" />';
  }
  else if(IsMicrosoft()) {
    return '<img style="border: 0pt none ; width: 25px; height: 96px;'+
    'position: absolute; z-index: 0; -moz-user-select: none; left: 237px;'+
    'top: 117px;" src="GoogleIcons/iw_se.gif" height="96" width="25" />';
  }
}
...
function GetTapImgUD() {
  if(IsNetscape() || IsSafari()) {
    return '<img style="border: 0pt none ; width: 98px; height: 96px;'+
    'position: absolute; z-index: 0; -moz-user-select: none; left: 0px;'+
    'top: 0px;" src="GoogleIcons/iw_tap_ud.png" height="96" width="98" />';
  }
  else if(IsMicrosoft()) {
    return '<img style="border: 0pt none ; width: 98px; height: 96px;'+
    'position: absolute; z-index: 0; -moz-user-select: none; left: 0px;'+
    'top: 0px;" src="GoogleIcons/iw_tap_ud.gif" height="96" width="98" />';
  }
}
...
function GetNImgUD() {
  if(IsNetscape() || IsSafari()) {
    return '<img style="border: 0pt none ; height: 96px;'+
    'position: absolute; z-index: 0; -moz-user-select: none; left: 98px;'+
    'width: 139px; top: 0px;" src="GoogleIcons/iw_n_ud.png" height="96" width="640" />';
  }
  else if(IsMicrosoft()) {
    return '<img style="border: 0pt none ; height: 96px;'+
    'position: absolute; z-index: 0; -moz-user-select: none; left: 98px;'+
    'width: 139px; top: 0px;" src="GoogleIcons/iw_n_ud.gif" height="96" width="640" />';
  }
}
...
function GetSWImgUD() {
  if(IsNetscape() || IsSafari()) {
    ...
    '-moz-user-select: none;" src="GoogleIcons/iw_sw_ud.png" height="25"'+
    ' width="25" />';
  }
  else if(IsMicrosoft()) {
    return '<img style="border: 0pt none; width: 25px; height: 25px; '+
    'position: absolute; left: 0px; top: 188px; z-index: 0; '+
    '-moz-user-select: none;" src="GoogleIcons/iw_sw_ud.gif" height="25"'+
    'width="25" />';
  }
}
...
function GetSImgUD() {
  ...
  'width: 212px;" src="GoogleIcons/iw_s_ud.png" height="25" width="640" />';
}
...
function GetSEImgUD() {
  if(IsNetscape() || IsSafari()) {
    ...
    '-moz-user-select: none; left: 237px;"'+
    ' src="GoogleIcons/iw_se_ud.png" height="25" width="25" />';
  }
  else if(IsMicrosoft()) {
    return '<img style="border: 0pt none ; width: 25px;'+
    'height: 25px; position: absolute; top: 188px; z-index: 0;'+
    '-moz-user-select: none; left: 237px;"'+
    ' src="GoogleIcons/iw_se_ud.gif" height="25" width="25" />';
  }
}
...
function GetCloseImg(ud) {  
  ...
  '237px; top: ' + top + 'px;" src="GoogleIcons/close.gif" '+
